<?php
    ...
    $artista = $_POST["artista"]; //name do input
    ...
    // echo $artista. "<br>";
    // echo $musicas. "<br>";
    // echo $singles. "<br>"; //só para exibir os dados na tela
    // echo $capa. "<br>";
    // echo $genero. "<br>";

    try {
        $stmt = $conn->prepare("INSERT INTO artistas (artista, musicas, singles, capa, genero)
        VALUES (:artista, :musicas, :singles, :capa, :genero)");
